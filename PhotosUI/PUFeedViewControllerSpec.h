...
+ (_Bool)shouldAvoidJPEGDecodeWorkDuringScrolling;
...
- (void)getFastImageFormat:(out int *)arg1 qualityImageFormat:(out int *)arg2 forSize:(struct CGSize)arg3 allowCrop:(_Bool)arg4;
