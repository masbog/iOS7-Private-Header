...
- (id)_windowWithUserInteractionEnabled:(_Bool)arg1 windowLevel:(double)arg2 createIfNeeded:(_Bool)arg3;
...
- (id)contentViewControllerWithUserInteractionEnabled:(_Bool)arg1 forService:(id)arg2;
...
- (void)setContentViewController:(id)arg1 userInteractionEnabled:(_Bool)arg2 forService:(id)arg3;

- (void)setContentViewController:(id)arg1 userInteractionEnabled:(_Bool)arg2 forService:(id)arg3 context:(void *)arg4 completion:(id)arg5;
