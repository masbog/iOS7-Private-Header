...
- (void)_remote_setStationData:(id)arg1 initialTrackBlobs:(id)arg2 bannerIdentifiers:(id)arg3 reply:(id)arg4;

- (void)_remote_setVisuallyEngaged:(_Bool)arg1;

- (void)_remote_songBegan:(id)arg1 bannerIdentifiers:(id)arg2 reply:(id)arg3;
