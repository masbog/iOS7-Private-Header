...

{
    ...
    _Bool _isAnonymousPlayer;

    _Bool _isUnknownPlayer;
...
@property(readonly, nonatomic) _Bool isAnonymousPlayer; // @synthesize isAnonymousPlayer=_isAnonymousPlayer;
...
@property(readonly, nonatomic) _Bool isUnknownPlayer; // @synthesize isUnknownPlayer=_isUnknownPlayer;
