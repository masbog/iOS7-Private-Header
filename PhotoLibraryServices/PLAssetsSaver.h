...
- (void)queueJobDictionary:(id)arg1 asset:(id)arg2 requestEnqueuedBlock:(id)arg3 completionBlock:(void)arg4 imageSurface:(id)arg5 previewImageSurface:(void)arg6 slalomRegions:(void *)arg7;
