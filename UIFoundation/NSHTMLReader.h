...
- (void)_addQuoteForLibXML2ElementNode:(struct _xmlNode *)arg1 opening:(_Bool)arg2 level:(long long)arg3;
...
- (_Bool)_enterLibXML2ElementNode:(struct _xmlNode *)arg1 tag:(id)arg2;
...
- (void)_newParagraphForLibXML2ElementNode:(struct _xmlNode *)arg1 tag:(id)arg2 allowEmpty:(_Bool)arg3 suppressTrailingSpace:(_Bool)arg4;
...
- (_Bool)_processLibXML2ElementNode:(struct _xmlNode *)arg1 tag:(id)arg2;
